...
class ProcessDocumentResponse(BaseModel):
    ...
    #: Identifies this document. Use it to poll status or submit an approval.
    document_id: str

    #: The user session this document belongs to. Generated by the API on the
    #: first upload; send it back on later uploads to keep them together.
    session_id: str
